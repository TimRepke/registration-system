...
--
-- Host: localhost:3306
-- Generation Time: Sep 24, 2014 at 09:10 PM
...
INSERT INTO `fahrten` (`fahrt_id`, `titel`, `ziel`, `von`, `bis`, `regopen`, `beschreibung`, `leiter`, `kontakt`, `map_pin`) VALUES
(1, 'Porno laut im Flur Fahrt', 'Irgendwo', '2012-10-17', '2012-10-19', 0, 'irgendein Text', 'Willi', 'hans@wurst.de', ''),
(2, 'Vodka in Hand Faart', 'Halbinsell', '2013-10-18', '2013-10-20', 1, 'Mehr Text passt nicht!&nbsp;<br><b>asdasd</b><br>', 'Timm', 'wahr@gi.nah', '52.46500637658367 13.90170872363285');
